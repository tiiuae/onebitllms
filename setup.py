# Copyright 2025 The HuggingFace and Falcon-LLM Team. All rights reserved.
#
...
#      pip install -i https://testpypi.python.org/pypi --extra-index-url https://pypi.org/simple onebitllms
# 8. Upload the final version to actual pypi:
#      twine upload dist/* -r pypi
# 9. Add release notes to the tag on https://github.com/tiiuae/onebitllms/releases once everything is looking hunky-dory.
